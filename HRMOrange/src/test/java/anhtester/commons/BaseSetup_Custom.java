...
public class BaseSetup_Custom {
    ...
    private WebDriver initChromeDriver() {
        ...
        driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(20)); //Chuyển trang đợi 20s, nếu ko load đc thì out
        return driver;
    }
